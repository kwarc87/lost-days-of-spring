...
export const DefaultLevelCompleteRenderer = {
    drawLevelCompleteScreen: (
        ...
        DefaultCollectibleRenderer.drawCoin(ctx, { x: coinsRowX, y: coinsRowY });
        ctx.textAlign = "left";
        ...
        DefaultCollectibleRenderer.drawSplinter(ctx, { x: splinterRowX, y: splinterRowY, w: ICON_SIZE, h: ICON_SIZE });
